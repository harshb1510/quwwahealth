        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-col md:flex-row ">
            ...
            <div className="md:w-1/2">
              <img src={futureImage1} alt="Comprehensive health monitoring" className="w-full h-full object-cover"/>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse rounded-2xl overflow-hidden ">
            ...
            <div className="md:w-1/2">
              <img src={futureImage2} alt="Curriculum development" className="w-full h-full object-cover"/>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row  ">
            ...
            <div className="md:w-1/2">
              <img src={futureImage3} alt="Comprehensive health monitoring" className="w-full h-full object-cover"/>
            </div>
          </div>
        </div>
      </div>
