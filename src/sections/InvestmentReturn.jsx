    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-yellow-50 via-yellow-50 to-white">
      <div className="container mx-auto">
        ...
        <div className="mt-24 flex justify-center">
            <div className="relative inline-block rounded-full border border-black/20  px-8 py-6 md:px-16 md:py-10">
                <img src={quwwaAlpro} alt="Quwwa Health + Alpro" className="h-12 md:h-16"/>
                <span className="absolute top-4 right-8 text-sm font-semibold text-gray-700">TM</span>
            </div>
        </div>
      </div>
    </section>
